 ...
 */
final class Version20210608115510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE score_team1 score_team1 INT NOT NULL, CHANGE score_team2 score_team2 INT NOT NULL');
    }
